	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="add-bookPrice" name="bookPrice" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写预订价格'" /></td>
            </tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
            ...
            <tr>
                <td align="right">价格:</td>
                <td><input type="text" id="edit-bookPrice" name="bookPrice" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写预订价格'" /></td>
            </tr>
            <tr>
                <td align="right">状态:</td>
                <td>
...
<script type="text/javascript">
	...
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
                ...
                $("#edit-bookPrice").val(item.bookPrice);
	...
	*/
	...
	$("#edit-accountId").combobox({
        onSelect:function(data){
            //console.log(data);
            var option = $("#edit-accountId option[value='"+data.value+"']");
    ...
    $("#add-roomTypeId").combobox({
        onSelect:function(data){
            ...
            $("#add-bookPrice").val(option.attr('price'));
        }
    });
    $("#edit-roomTypeId").combobox({
        onSelect:function(data){
            //console.log(data);
            var option = $("#edit-roomTypeId option[value='"+data.value+"']");
            $("#edit-bookPrice").val(option.attr('price'));
        }
    });
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
            ...
            { field:'bookPrice',title:'预订价格',width:100,sortable:true},
            ...
            { field:'defaultPrice',title:'违约金额',width:100,sortable:true},
