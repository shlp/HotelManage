	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                    <select id="add-roleId" name="roleId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择角色'">
                        <c:forEach items="${roleList }" var="role">
                            <option value="${role.id }">${role.name }</option>
                        </c:forEach>
                    </select>
	...
	<form id="edit-form" method="post">
        ...
        <tr>
            ...
            <tr>
                <td width="60" align="right">性别:</td>
                <td>
                    <select name="edit-sex" class="easyui-combobox" panelHeight="auto" style="width:268px">
                        <option value="0">未知</option>
                        <option value="1">男</option>
                        <option value="2">女</option>
                    </select>
