...
<body>
  ...
  <header style="position:relative;height:50px;">
    <div style="width:248px; position:absolute;height:50px;background-color:#fe6d6d;color:#fff;font-family:'Arial Black',Gadget, sans-serif;font-size:30px">
      酒店信息管理系统
    </div>
  </header>
  <!--中间部分-->
