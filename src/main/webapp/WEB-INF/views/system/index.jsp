...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2020,考研一组, Ltd." />
<title>后台管理主页</title>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
        	<p><strong class="easyui-tooltip" title="0条未读消息">${role.name}:${admin.name}</strong>，欢迎您！</p>
            <p><a href="../home/index">网站首页</a>|<a href="#">支持论坛</a>|<a href="#">帮助中心</a>|<a href="logout">安全退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2020【考研一组】 All Rights Reserved
    </div>
    <!-- end of footer -->  
